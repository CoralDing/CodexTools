#!/usr/bin/env bash
# 文件说明：构建 SubPilot 应用并生成可拖入“应用程序”文件夹安装的 DMG
# 作者：dingyi60(Codex)
# 创建时间：2026-08-26
...
readonly DMG_PATH="${PROJECT_ROOT}/dist/SubPilot-${VERSION}-macos-${ARCHITECTURE}.dmg"
...
cp -R "${APP_BUNDLE}" "${STAGING_DIR}/SubPilot.app"
